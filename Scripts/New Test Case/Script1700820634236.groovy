...
WebUI.click(findTestObject('Object Repository/Page_Evolvity/div_course1 description in english'))

WebUI.click(findTestObject('Object Repository/Page_Evolvity/div_Programoptimizationdescription in engli_71910a'))

//WebUI.getText(findTestObject('Object Repository/Page_Evolvity/div_course1 description in english'))



if (WebUI.getText(findTestObject('Object Repository/Page_Evolvity/div_course1 description in english')).length()<0)
{
	throw new com.kms.katalon.core.exception.StepErrorException("There is an exception")
}
else {
	println ('pass')
	WebUI.rightClick(findTestObject('Object Repository/Page_Evolvity/div_course1 description in english'))
}
